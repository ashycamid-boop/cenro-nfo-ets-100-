...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcer/profile.css">
...
<body class="admin-dashboard-page admin-profile-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="enforcerProfileSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="enforcerProfileSidebar">
  ...
  <script src="../../../../public/assets/js/enforcer/profile.js"></script>
