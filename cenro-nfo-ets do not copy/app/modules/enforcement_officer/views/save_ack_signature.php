...
if (!in_array($roleNorm, ['enforcement_officer', 'enforcement officer'], true)) {
...
require_once __DIR__ . '/../../../views/partials/enforcement_officer_signature_helper.php';
...
try {
  $ackBy = $_SESSION['full_name'] ?? 'Enforcement Officer';
  ...
  echo json_encode(['ok' => true, 'path' => enforcement_officer_signature_proxy_url($dbPath), 'ack_by' => $ackBy]);
} catch (Exception $e) {
  http_response_code(500);
