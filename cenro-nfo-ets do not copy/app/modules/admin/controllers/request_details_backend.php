...
require_once __DIR__ . '/../../../views/partials/admin_signature_helper.php';

// Defaults for optional diagnostics shown by the view.
$save_error = null;
$debug_info = [];
...
$ack_sig_url = !empty($request['ack_signature_path']) ? admin_signature_proxy_url($request['ack_signature_path']) : '';
