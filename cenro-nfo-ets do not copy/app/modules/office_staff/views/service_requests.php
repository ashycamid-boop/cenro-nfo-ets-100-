...
<body class="admin-dashboard-page enforcement-service-requests-page">
  <div class="layout">
    ...
    <nav class="sidebar" id="officeStaffServiceRequestsSidebar" role="navigation" aria-label="Main sidebar">
      <div class="sidebar-logo">
        <img src="../../../../public/assets/images/denr-logo.png" alt="DENR Logo">
        <span>CENRO</span>
      </div>
      <div class="sidebar-role"><?php echo htmlspecialchars((string)($sidebarRole ?? 'Office Staff'), ENT_QUOTES, 'UTF-8'); ?></div>
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="officeStaffServiceRequestsSidebar">
