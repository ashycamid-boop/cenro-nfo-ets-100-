...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/admin/assigned_devices.css?v=20260515-responsive">
...
<body>
  ...
  <div class="layout">
    ...
    <nav class="sidebar" id="adminAssignedDevicesSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="adminAssignedDevicesSidebar">
