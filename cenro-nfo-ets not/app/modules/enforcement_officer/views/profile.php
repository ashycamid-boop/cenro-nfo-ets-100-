...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcement_officer/profile.css">
...
<body class="admin-dashboard-page admin-profile-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="enforcementOfficerProfileSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="enforcementOfficerProfileSidebar">
...
<?php else: ?>
  ...
  <script src="../../../../public/assets/js/shared/profile-image-cropper.js"></script>
    ...
    <!-- Profile JavaScript -->
  <script src="../../../../public/assets/js/enforcement_officer/profile.js"></script>
