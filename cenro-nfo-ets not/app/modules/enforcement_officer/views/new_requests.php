...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcement_officer/new_requests.css?v=20260320-2">
...
<body class="admin-dashboard-page service-request-form-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="enforcementOfficerNewRequestsSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="enforcementOfficerNewRequestsSidebar">
  ...
  <script src="../../../../public/assets/js/enforcement_officer/new_requests.js?v=20260520-signature-required"></script>
</body>
</html>
