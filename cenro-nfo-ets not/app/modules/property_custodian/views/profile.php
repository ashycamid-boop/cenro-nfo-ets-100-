...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/property_custodian/profile.css">
...
<body class="admin-dashboard-page admin-profile-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="propertyCustodianProfileSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="propertyCustodianProfileSidebar">
  ...
  <script src="../../../../public/assets/js/property_custodian/profile.js"></script>
</body>
</html>
