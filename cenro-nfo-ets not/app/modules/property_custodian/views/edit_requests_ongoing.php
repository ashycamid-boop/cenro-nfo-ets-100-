...
<body class="admin-dashboard-page property-custodian-edit-requests-ongoing-page service-request-form-page" data-current-user-id="<?php echo htmlspecialchars((string)($sessionUserId ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
  <div class="layout">
    <button class="mobile-sidebar-backdrop" type="button" aria-label="Close sidebar"></button>
    <!-- Sidebar -->
    <nav class="sidebar" id="propertyCustodianEditRequestsOngoingSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="propertyCustodianEditRequestsOngoingSidebar">
