...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcer/request_details.css?v=20260515-mobile">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
</head>
<body class="admin-dashboard-page enforcer-request-details-page service-request-form-page" data-rating-finalized="<?php echo $rating_finalized ? '1' : '0'; ?>">
  <div class="layout">
    <button class="mobile-sidebar-backdrop" type="button" aria-label="Close sidebar"></button>
    <!-- Sidebar -->
    <nav class="sidebar" id="enforcerRequestDetailsSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="enforcerRequestDetailsSidebar">
                      ...
                      <tr>
                        ...
                        <td style="border-bottom: 1px solid black; padding: 6px; text-align:center; vertical-align:middle;">
                          <?php if (!empty($action['action_signature_path'])): ?>
                            <img src="<?php echo htmlspecialchars(enforcer_signature_proxy_url($action['action_signature_path'])); ?>" alt="Action Signature" style="max-height:48px; max-width:100%;" />
                          <?php else: ?>
  ...
  <script src="../../../../public/assets/js/enforcer/request_details.js"></script>
