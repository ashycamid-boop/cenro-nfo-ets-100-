document.addEventListener('DOMContentLoaded', function() {
  ...
  const activeFilters = document.getElementById('caseManagementActiveFiltersAdmin');
  const filtersModal = document.getElementById('caseManagementFiltersModalAdmin');
    ...
    if (tbody) {
      ...
      if (visibleCount === 0) {
        if (!placeholder) {
          ...
          row.innerHTML = '<td colspan="9" class="text-center">No approved cases found.</td>';
