...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/admin/ongoing_scheduled.css?v=20260521-live-filter">
...
<body class="admin-dashboard-page admin-ongoing-scheduled-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="adminOngoingScheduledSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="adminOngoingScheduledSidebar">
  ...
  <script src="../../../../public/assets/js/admin/ongoing_scheduled.js?v=20260521-live-filter"></script>
