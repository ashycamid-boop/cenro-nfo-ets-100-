...
require_once __DIR__ . '/../../../views/partials/property_custodian_signature_helper.php';
...
try {
  $ackBy = $_SESSION['full_name'] ?? 'Property Custodian';
  ...
  echo json_encode(['ok' => true, 'path' => property_custodian_signature_proxy_url($dbPath), 'ack_by' => $ackBy]);
} catch (Exception $e) {
  http_response_code(500);
