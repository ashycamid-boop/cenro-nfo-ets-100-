...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcer/new_requests.css?v=20260320-1">
...
<body class="admin-dashboard-page service-request-form-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="enforcerNewRequestsSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="enforcerNewRequestsSidebar">
  ...
  <script src="../../../../public/assets/js/enforcer/new_requests.js?v=20260520-signature-required"></script>
</body>
</html>
