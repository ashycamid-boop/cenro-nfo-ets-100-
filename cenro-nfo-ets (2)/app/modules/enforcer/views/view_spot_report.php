...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/enforcer/view_spot_report.css?v=20260515-mobile2">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
    <!-- Layout override: enlarge main content like admin case_details -->
    
</head>
<body class="admin-dashboard-page enforcer-view-spot-report-page">
  <div class="layout">
    <button class="mobile-sidebar-backdrop" type="button" aria-label="Close sidebar"></button>
    <!-- Sidebar -->
    <nav class="sidebar" id="enforcerViewSpotReportSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
          <div class="topbar-card">
            <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="enforcerViewSpotReportSidebar">
                      ...
                      <td>
                        <?php
                          ...
                          if ($t !== null || $w !== null || $l !== null) {
                            ...
                            echo htmlspecialchars(implode(' × ', $parts) . ' (in × in × ft)');
                          } else {
                            echo '<span class="text-muted">-</span>';
                          }
                        ?>
                        ...
                        <?php
                          ...
                          if (isset($it['volume_bdft']) && $it['volume_bdft'] !== null && $it['volume_bdft'] !== '') {
                            ...
                            if ($qtyRaw !== null && $qtyRaw !== '') {
                              if (is_numeric($qtyRaw)) $qty = (float)$qtyRaw;
                              else {
                                $qnum = preg_replace('/[^0-9\.\-]/', '', (string)$qtyRaw);
                                if ($qnum !== '') $qty = (float)$qnum;
                              }
                            }
                            if ($t !== null && $w !== null && $l !== null && $qty !== null && is_numeric($t) && is_numeric($w) && is_numeric($l)) {
                              $computed = ((float)$t * (float)$w * (float)$l) / 12 * (float)$qty;
                              echo htmlspecialchars(number_format($computed, 3));
  ...
  <script src="../../../../public/assets/js/enforcer/view_spot_report.js"></script>
</body>
</html>
