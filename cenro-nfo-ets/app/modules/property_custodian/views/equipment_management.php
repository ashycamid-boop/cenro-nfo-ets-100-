...
<head>
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/property_custodian/equipment_management.css?v=20260520-missing-purple">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
  
</head>
<body class="admin-dashboard-page admin-equipment-management-page property-custodian-equipment-management-page" data-preloaded-users="<?php echo htmlspecialchars(json_encode($preloadedUsers, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES), ENT_QUOTES, 'UTF-8'); ?>">
  <div class="layout">
    <button class="mobile-sidebar-backdrop" type="button" aria-label="Close sidebar"></button>
    <!-- Sidebar -->
    <nav class="sidebar" id="propertyCustodianEquipmentManagementSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="propertyCustodianEquipmentManagementSidebar">
            ...
            <div class="row g-3 align-items-center">
              <div class="col-12 col-xl-8">
                <div class="d-flex gap-2">
                  ...
                  <button class="btn btn-success" type="button" id="printEquipmentListBtn" onclick="window.__propertyCustodianEquipmentTopActions && window.__propertyCustodianEquipmentTopActions.printList()">
                    <i class="fa fa-print me-2"></i>Print
                  </button>
                  <button class="btn btn-outline-success" type="button" id="exportEquipmentExcelBtn" onclick="window.__propertyCustodianEquipmentTopActions && window.__propertyCustodianEquipmentTopActions.exportExcel()">
                    <i class="fa fa-file-excel me-2"></i>Export Excel
                  </button>
                </div>
              </div>
