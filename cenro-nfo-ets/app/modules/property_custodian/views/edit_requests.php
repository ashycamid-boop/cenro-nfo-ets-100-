...
<head>
  ...
  <?php require_once __DIR__ . '/../../../views/partials/property_custodian_signature_helper.php'; ?>
  <!-- Bootstrap 5 CSS -->
  ...
  <link rel="stylesheet" href="../../../../public/assets/css/modules/property_custodian/edit_requests.css?v=20260515-mobile">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.2/css/all.min.css">
  <link href="https://fonts.googleapis.com/css?family=Fredoka+One:400&display=swap" rel="stylesheet">
</head>
<body class="admin-dashboard-page property-custodian-edit-requests-page" data-current-user-id="<?php echo htmlspecialchars((string)($sessionUserId ?? ''), ENT_QUOTES, 'UTF-8'); ?>">
  <div class="layout">
    <button class="mobile-sidebar-backdrop" type="button" aria-label="Close sidebar"></button>
    <!-- Sidebar -->
    <nav class="sidebar" id="propertyCustodianEditRequestsSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="propertyCustodianEditRequestsSidebar">
                        ...
                        <td style="border-bottom: 1px solid black; padding: 2px;">
                          <div class="signature-box" data-field="action_sig_<?php echo $i; ?>" data-staff-id="<?php echo htmlspecialchars($act['action_staff_id']); ?>" style="<?php echo $sig_box_style; ?>">
                            <?php if (!empty($act['action_signature_path'])): ?>
                              <img id="action_sig_<?php echo $i; ?>_preview" src="<?php echo htmlspecialchars(property_custodian_signature_proxy_url($act['action_signature_path'])); ?>" style="max-height:48px; max-width:100%; display:block;" />
                            <?php else: ?>
  ...
  <select id="actionStaffOptionsTemplate" class="d-none">
  ...
  <script src="../../../../public/assets/js/property_custodian/edit_requests.js?v=20260606-pending-signature-english"></script>
</body>
</html>
