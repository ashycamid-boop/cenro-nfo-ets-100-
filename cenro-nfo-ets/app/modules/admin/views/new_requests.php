...
<body class="admin-dashboard-page admin-new-requests-page">
  <div class="layout">
    ...
    <!-- Sidebar -->
    <nav class="sidebar" id="adminNewRequestsSidebar" role="navigation" aria-label="Main sidebar">
    ...
    <div class="main">
      <div class="topbar">
        <div class="topbar-card">
          <button class="mobile-nav-toggle" type="button" aria-label="Open navigation" aria-expanded="false" aria-controls="adminNewRequestsSidebar">
